...
const Favorite = () => {
  ...
  return movies.length > 0 ? (
    <div className="relative my-24 md:my-32 px-6 md:px-16 lg:px-24 xl:px-32 overflow-hidden min-h-[80vh]">
      ...
      <h1 className="text-2xl md:text-3xl font-semibold mb-8 text-white">On screens now</h1>
    ...
    <div className="flex flex-col items-center justify-center h-[70vh] text-center">
      <h1 className="text-3xl md:text-4xl font-bold text-gray-300">Nothing here yet</h1>
      <p className="mt-3 text-gray-500 text-lg">Browse movies with active showtimes.</p>
    </div>
  );
};
